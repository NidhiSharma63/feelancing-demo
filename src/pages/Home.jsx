      ...
      <div className="flex flex-col gap-3 w-1/2  mt-40 ml-20 pb-10 justify-around border-2 border-amber-400">
       ...
       <div className="text-8xl ">
        ...
        <div className="flex gap-6 ">
          <button className="bg-green-700 cursor-pointer w-[200px] py-[10px] text-white text-sm">
            Explore by
            <hr className="text-green-700"/>
            <p className="text-xl">Solution</p>
          </button>
          <button className="bg-green-700 cursor-pointer text-white w-[200px] text-sm">
            Explore by
            <hr className="text-green-700"/>
